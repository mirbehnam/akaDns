...
این پروژه حالا دو دایرکتوری جدا دارد:
...
فایل `windows/run-dns-scripts.bat` را اجرا کنید و یکی از گزینه‌های زیر را انتخاب نمایید:
...
ابتدا وارد دایرکتوری `linux/` شوید و سپس اسکریپت را با دسترسی روت اجرا کنید:
